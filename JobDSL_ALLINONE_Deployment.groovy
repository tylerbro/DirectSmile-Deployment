...
job('DirectSmile__Deployment_'+ SERVERNAME) {
	...
	//***************************************************************************
		...
		choiceParam('ENABLEWF', ENABLEWF,'<h3><font color="red">Only Valid &gt; Ver7.2.0.52</font></h3> <p>ENABLEWF=1|0 enables the Workflow(1) or disables it (0), default is ENABLEWF=1</p>')
