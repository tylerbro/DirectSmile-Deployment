...
job('DSMG_Deployment__' + CUSTOMER_NAME) {
	parameters {
		...
		booleanParam('ALLUSERS', ALLUSERS, '<p>If ALLUSERS=True(Automatically convert to ALLUSERS=1 in actual deployment script), Register components for all users.</p>')
		booleanParam('CLIENTUILEVEL', CLIENTUILEVEL, '<p>If ALLUSERS=True(Automatically convert to ALLUSERS=1 in actual deployment script), Register components for all users.</p>')
