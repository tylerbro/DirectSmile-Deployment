...
job('DSMG_Deployment' + CUSTOMER_NAME) {
    parameters {
        ...
        choiceParam('Deploy_Version', ['DSMG_LATEST_RELEASE(default)', 		'DSMG_LATEST_STABLE_RELEASE', 'DSMG_DSF_RELEASE', 'DSMG_VER5_1_x', 'DSMG_VER5_4_x', 'DSMG_VER6_0_x', 'DSMG_TRUNK_VERSION', 'DSMG_SPECIFIC_VERSION'])
